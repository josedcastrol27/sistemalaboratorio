...
<html lang = "en">
	...
	<div class = "well">
		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				<label>HEMATOLOGY FORM</label>	<a style = "float:right; margin-top:-4px;" href = "hematology_pending.php?itr_no=<?php echo $_GET['itr_no']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
			</div>
			...
			<div class = "alert alert-info">Basic Information</div>	
				...
				<br />
				<div class = "form-inline">
					<button class = "btn btn-primary" name = "save_h" ><span class = "glyphicon glyphicon-save"></span> GUARDAR</button>
				</div>
			</div>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Sistema Laboratotio</label>
	</div>
	</body>
