...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "" style = "float:left;" height = "55px"><label class = "navbar-brand">Sistema Laboratorio</label>
	...
	<div class = "well">
		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				<label>HEMATOLOGY RESULT FORM</label>	<a style = "float:right; margin-top:-4px;" href = "hematology_record.php?itr_no=<?php echo $_GET['itr_no']?>&hem_id=<?php echo $_GET['hem_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Sistema de Laboratorio	</div>
	</body>
