...
<html lang = "en">
	...
	<div class = "well">
		...
		<div class = "panel panel-default">
			<div class = "panel-heading">
				<label>PATIENT'S DATA FORM</label>	<a style = "float:right; margin-top:-4px;" href = "birthing_pending.php?id=<?php echo $_GET['id']?>&lastname=<?php echo $_GET['lastname']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
			</div>
