	...
	<div class = "well">
		...
		<div id = "p_fdental" class = "panel panel-success">	
			<div class = "panel-heading">
				...
				<a style = "float:right; margin-top:-4px;" href = "xray.php" class = "btn btn-info"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a>
			</div>
			<?php
				$_GET['id'];
				$_GET['lastname'];
			...
			<div class = "panel-body">
				<form id = "form_dental" action = "edit_patient.php?id=<?php echo $fetch['itr_no']?>&lastname=<?php echo $fetch['lastname']?>" method = "POST" enctype = "multipart/form-data">
					...
					<div class = "form-inline">
						...
						<label style = "float:right; margin-top:5px;" for = "phil_health_no">Medicacion:</label>
					</div>
					<br />
					<div class = "form-inline">
