...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "" style = "float:left;" height = "55px" /><label class = "navbar-brand">Sistea de Laboratorio</label>
	...
	<div class = "well">
		...
		<div class = "panel panel-success">	
			...
			?>
				...
				<a style = "float:right; margin-top:-4px; margin-right:5px;" href = "hematology_pending.php?itr_no=<?php echo $f['itr_no']?>" class = "btn btn-info">ATENCIÓN <span class = "badge"> <?php echo $f1['total']?></span></a>
	...
	<div id = "footer">
		<label class = "footer-title">&copy;Sistema de Laboratorio</a></label>
	</div>
	</body>
