...
<button><a style = "text-decoration:none; color:#000;" href = "hematology_form.php?itr_no=<?php echo $f['itr_no']?>&hem_id=<?php echo $_GET['hem_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-print">VOLVER</a></button>
<br />
<br />
	<div id="print">
		<div style = "margin:10px;">	
			...
			<div style = "float:left; width:40%; margin-left:10px; position:relative; top:-20px;">
				...
				<label style = "font-size:12px; position:relative; top:-40px; margin-left:20px;">Rh Group: 
					...
					?></label>
				<label style = "font-size:12px; position:relative; right:30%;"><b>Observaciones:</b></label>
				<br />
