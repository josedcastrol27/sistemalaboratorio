...
<html lang = "en">
	...
	<div class = "navbar navbar-default navbar-fixed-top">
		<img  style = "float:left;" height = "55px"><label class = "navbar-brand">Sistema Laboratotio</label>
	...
	<div class = "well">
		...
		<br />
		<table id = "table" class = "display" cellspacing = "5" >
			<thead>
				<tr>
			...
			?>
				<tr>
					...
					<td>
						<center>
							<a href = "view_hematology.php?itr_no=<?php echo $fetch['itr_no']?>"class = "btn btn-sm btn-info"><span class = "glyphicon glyphicon-search"></span> VER DETALLES</a> 
						</center>
					</td>
				</tr>
			<?php
