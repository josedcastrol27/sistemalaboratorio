	...
	<div id = "content">
		...
		<br />
			<?php
				...
				$f = $q->fetch_array();
			?>
			<div class = "alert alert-info">Maternity Record<a class = "btn btn-success" style = "float:right; margin-top:-7px;" href = "maternity_record.php?itr_no=<?php echo $f2['itr_no']?>"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a></div>
