...
<body>
	...
	<div id = "content">
		...
		<?php
			...
			$f1 = $q1->fetch_array();
		?>
		<div class = "alert alert-info">Registro Dental / <?php echo $f1['firstname']." ".substr($f1['middlename'], 0,1).$f1['lastname']?><a class = "btn btn-success" style = "float:right; margin-top:-7px;" href = "dental.php"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a></div>
