...
<body>
	...
	<div id = "content">
		...
		<?php
			...
			$f = $q->fetch_array();
		?>
		<div class = "alert alert-info">Basic Information 	<a class = "btn btn-success" style = "float:right; margin-top:-5px;" href = "sputum_record.php?itr_no=<?php echo $f['itr_no']?>"><span class = "glyphicon glyphicon-hand-right"></span> VOLVER</a></div>
		<div style = "float:left; width:30%;">
				...
				<div style = "float:left; width:10%;">	
					<label style = "font-size:15px;" for = "age">Edad</label>
					<br />
					<label style = "font-size:15px;" class = "text-muted"><?php echo $f['age']?></label>
				</div>	
				<div style = "float:left; width:10%;">	
					<label style = "font-size:15px;" for = "gender">Genero:</label>
					<br />
