			...
			<table id = "table" cellspacing = "0" class = "display">
				...
				?>
					<tr>
						...
						<td><center><a class = "btn btn-primary" href = "sputum_record.php?itr_no=<?php echo $fetch['itr_no']?>"><span class = "glyphicon glyphicon-search"></span> Todos los Registros</a></center></td>
					</tr>
				<?php
					}
				?>		
