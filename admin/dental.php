...
<body>
	...
	<div id = "content">
		...
		<br />
		<div id = "target">
			<div class = "alert alert-info">Registro Dental</div>
			<table id = "table" cellspacing = "0" class = "display">
				...
				?>
					<tr>
						...
						<td><center><a class = "btn btn-primary" href = "dental_record.php?itr_no=<?php echo $fetch['itr_no']?>"><span class = "glyphicon glyphicon-search"></span> Todos los Registros</a></center></td>
					</tr>
				<?php
					}
				?>		
